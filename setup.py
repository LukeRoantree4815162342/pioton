...
setup(
  ...
  description = 'píotón is a tool to tweak IPython to allow coding in Irish. Not for use in any important work',   # Give a short description about your library
  ...
  download_url = 'https://github.com/LukeRoantree4815162342/pioton/archive/v_01.tar.gz',    # I explain this later on
